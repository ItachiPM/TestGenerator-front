...
export const ModuleTestSettings = () => {
    ...
    return <div className="ModuleTestSettings">
        ...
        <div className="options">
            ...
            <label>
                <p>Ilość pytań:</p>
                <input type="number" value={testParameter.questionCount}
                       onChange={e => handleTestParameter('questionCount', e.target.value)}/>
            </label>
            <p>
                {testParameter.module === "Wybierz" ? 'Żeby rozpocząć test musisz wybrać przedmiot'
                    :
                    <Link className="button"
                          to={`/generator/module/${testParameter.module}/${testParameter.questionCount}`}>Rozpocznij
                        Test!</Link>}
            </p>
        </div>
    </div>
