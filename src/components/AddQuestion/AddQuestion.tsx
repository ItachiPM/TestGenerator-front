...
export const AddQuestion = () => {
    ...
    const sendFrom = async (e: FormEvent) => {
        ...
        try {
            ...
            if(!res.ok) {
                ...
                setSuccess(`Dodano nowe pytanie do przedmiotu ${data.module}`)
    ...
    return <div className="AddQuestion">
        <Title/>
        <h2>Dodaj Pytanie</h2>
        {success === null ? null : <div className="correct-add-question">{success}</div>}
                    ...
                    <label>
                        ...
                        <p>
                            <button className="module--button" type="button"
                                    onClick={() => setAddNewModule(!addNewModule)}>Wybierz z listy</button>
                        </p>
                    </label>
                    :
                    <label>
                        ...
                        <p>
                            <button className="module--button" type="button" onClick={() => setAddNewModule(!addNewModule)}>Dodaj nowy przedmiot</button>
                        </p>
                    </label>}
            </div>
            <div className="section">
